// src/components/policies/PrivacyPolicy.tsx
export default function PrivacyPolicy() {
  return (
    <article className=" flex flex-col mx-auto max-w-3xl px-4 py-12 space-y-8">
      ...
      <section>
        <h2 className="text-xl font-semibold text-wondergreen">Information We Collect</h2>
      ...
      <section>
        <h2 className="text-xl font-semibold text-wondergreen"> How We Use Information</h2>
        <ul className="mt-2 list-disc pl-6 space-y-1 text-gray-800">
      ...
      <section>
        <h2 className="text-xl font-semibold text-wondergreen"> Legal Basis / Consent</h2>
        <p>
      ...
      <section>
        <h2 className="text-xl font-semibold text-wondergreen"> Sharing & Service Providers</h2>
      ...
      <section>
        <h2 className="text-xl font-semibold text-wondergreen"> Payments & Donations</h2>
        <p className="mt-2">
      ...
      <section>
        <h2 className="text-xl font-semibold text-wondergreen">Cookies & Analytics</h2>
        <p className="mt-2">
      ...
      <section>
        <h2 className="text-xl font-semibold text-wondergreen">Storage, Location & Security</h2>
        <ul className="mt-2 list-disc pl-6 space-y-1 text-gray-800">
      ...
      <section>
        <h2 className="text-xl font-semibold text-wondergreen">Your Choices & Rights</h2>
        <ul className="mt-2 list-disc pl-6 space-y-1 text-gray-800">
      ...
      <section>
        <h2 className="text-xl font-semibold text-wondergreen">Children's Privacy</h2>
        <p className="mt-2">
      ...
      <section>
        <h2 className="text-xl font-semibold text-wondergreen">International Users</h2>
        <p className="mt-2">We operate in the United States and store/process data in the U.S. only.</p>
      </section>

      <section>
        <h2 className="text-xl font-semibold text-wondergreen">Third-Party Links</h2>
        <p className="mt-2">Our site may link to third-party websites/services with their own privacy practices.</p>
      </section>

      <section>
        <h2 className="text-xl font-semibold text-wondergreen">Changes to This Policy</h2>
        <p className="mt-2">
