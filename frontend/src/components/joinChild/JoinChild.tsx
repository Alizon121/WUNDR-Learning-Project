...
const JoinChild = () => {
    ...
    const AllChildren = async () => {
        const response = await fetch("http://localhost:8000/child/ping")
    ...
    AllChildren().then((children) => {
        console.log('look here', children)
    })
    ...
    return (
        <>
            <button>Need to add another child?</button>
